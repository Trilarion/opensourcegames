...
- Code repository: https://codeberg.org/osgames/dangerdeep.git (conversion and cleanup of git), https://git.code.sf.net/p/dangerdeep/git (@add), https://svn.code.sf.net/p/dangerdeep/code (svn)
- Code language: C++, C
