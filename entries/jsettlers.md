...
- Code repository: https://github.com/jdmonin/JSettlers2.git (@created 2012, @stars 127, @forks 59), http://jsettlers.cvs.sourceforge.net (cvs), http://jsettlers2.cvs.sourceforge.net (cvs)
- Code language: Java
