...
- Code repository: https://github.com/Nop90-Switch/Meritous-Switch.git (import of version 1.2, @created 2018, @stars 2, @forks 0), https://gitlab.com/meritous/sdl_android.git @add, https://gitlab.com/meritous/meritous.git @add
- Code language: C
