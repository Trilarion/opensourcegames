...
- Code repository: https://github.com/rpmcruz/microracers.git (@created 2019, @stars 2, @forks 0), https://codeberg.org/osgames/microracers.git (@add, conversion of cvs)
- Code language: C, C++
