...
- Platform: Web
- Keyword: strategy
- Code repository: https://github.com/kantoks/skrupel.git (continuation, @created 2011, @stars 17, @forks 9), https://gitlab.com/osgames/skrupel.git @add (@created 2018, @stars 1, @forks 0), http://skrupel.cvs.sourceforge.net/ (cvs)
