...
- **[Chrzaszcz](../chrzaszcz.md)** (C++, GPL-3.0, beta, inactive since 2023)
...
- **[Harmony Blocks](../harmony_blocks.md)** (TypeScript, JavaScript, Python, MIT, beta)
...
- **[Ikemen GO](../ikemen_go.md)** (Go, MIT, beta)
...
- **[Kobo Deluxe](../kobo_deluxe.md)** (C, C++, GPL-2.0, beta, inactive since 2007)
...
- **[l-echo](../l-echo.md)** (C++, GPL-3.0, beta, inactive since 2009)
...
- **[Ladder](../ladder.md)** (Java, GPL-2.0, mature, inactive since 2020)
...
- **[NetHack - Falcon's Eye](../nethack-falcons_eye.md)** (C, NetHack General Public License, mature, inactive since 2004)
...
- **[One Way To Go](../one_way_to_go.md)** (Lua, GPL-3.0, mature, inactive since 2017)
...
- **[Orbit-Hopper](../orbit-hopper.md)** (C++, GPL-2.0, mature, inactive since 2009)
...
- **[PipeWalker](../pipewalker.md)** (C++, GPL-3.0, mature)
...
- **[RPG Tactical Fantasy Game](../rpg_tactical_fantasy_game.md)** (Python, GPL-3.0, mature)
...
- **[rsc-c](../rsc-c.md)** (C, C++, AGPL-3.0, mature)
...
- **[Serious Engine](../serious_engine.md)** (C, C++, GPL-2.0, mature, inactive since 2017)
...
- **[Story of a Lost Sky](../story_of_a_lost_sky.md)** (Python, 3-clause BSD, mature, inactive since 2016)
...
- **[The Gates of Skeldal](../the_gates_of_skeldal.md)** (C, GPL-3.0, mature, inactive since 2013)
- **[The House](../the_house.md)** (JavaScript, MIT, mature, inactive since 2019)
- **[The hunt for the lost rainbow jewels (Jewelhunt)](../the_hunt_for_the_lost_rainbow_jewels_jewelhunt.md)** (Java, GPL-2.0, beta, inactive since 2016)
...
- **[TrinityCore](../trinitycore.md)** (C++, GPL-2.0, mature)
...
- **[Vange-rs](../vange-rs.md)** (Rust, Apache-2.0, beta)
...
- **[VoxeLibre](../voxelibre.md)** (Lua, GPL-3.0, beta)
...
- **[ZEQ2 Lite](../zeq2_lite.md)** (C, C++, GPL-2.0, beta)
...
- **[ZGloom](../zgloom.md)** (C++, Custom, mature)
