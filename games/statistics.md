...
analyzed 432 entries on 2019-06-24 15:50:51
...
Without license tag: 3 (0.7%)

Core War, Imperium, Netrek
...
26: Advanced Strategic Command, Blender game engine, Core War, Deliantra, Fanwor, FreeRails, FreeType, Freedink, KAtomic, Libxml2, LordsAWar!, Mechanized Assault & eXploration Reloaded , Netrek, Open AL Soft, Open Rails, PARPG, Ragel, Rocks'n'Diamonds , Simple DirectMedia Layer, Tales of Maj'Eyal, Turious, Waste's Edge, Wolfpack Empire, XZ Utils, pkg-config, rpge

## Build systems

Build systems information available for 20.6% of all projects.

##### Build systems frequency (89)
...
##### C and C++ projects without build system information (180)
...
##### C and C++ projects with a build system different from CMake (57)
...
Platform information available for 20.1% of all projects.
