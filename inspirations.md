...
- Inspired entries: "Achtung, die Kurve!", Curvytron, Netacka, Zatacka, Zatacka X
...
- Inspired entries: DarkFO, Fallout 2 Community Edition, Falltergeist, jsFO, PARPG, sfall
...
- Inspired entries: Darkflame Universe
...
- Inspired entries: 2H4U, 4D-TRIS, Bastet, Block Puzzle Stone Wars, canvas-tetris, Cuyo, Freebloks 3D for Android, Gem Drop X, Gottet, Hextris, Just another Tetris™ clone, LTris, NullpoMino, OpenBlok, Quadrapassel, Spludlow Tetris, T^3, Tetris (in C and NCURSES), vitetris, Xultris
