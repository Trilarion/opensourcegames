...
analyzed 561 entries on 2019-08-21 23:42:00
...
- library (1.7%)
- puzzle (1.7%)
- requires original content (1.6%)
- shooter (1.4%)
- massive multiplayer online (1.4%)
- online (1.3%)
- tool (1.2%)
- open content (1.1%)
- adventure (1.1%)
...
- racing (0.6%)
- sports (0.6%)
- commercial content (0.5%)
- inspired by Simcity (0.5%)
- inspired by X-COM series (0.4%)
- platform (0.4%)
- text-based (0.4%)
- cards (0.3%)
- popular (0.3%)
...
- inspired by Breakout (0.2%)
- inspired by Civilization II (0.2%)
- inspired by Escape Velocity (0.2%)
- inspired by Legend of Zelda (0.2%)
- inspired by Lemmings (0.2%)
- inspired by Liero (0.2%)
- inspired by Master of Orion (0.2%)
- inspired by Minecraft (0.2%)
- inspired by Nuclear Reaction (0.2%)
- inspired by RollerCoaster Tycoon (0.2%)
- inspired by Scorched Earth (0.2%)
- inspired by Sid Meier's Colonization (0.2%)
- inspired by Transport Tycoon (0.2%)
- inspired by Warcraft II (0.2%)
- isometric (0.2%)
- kids (0.2%)
- multiplayer (online (0.2%)
- multiplayer online + LAN (0.2%)
- port (0.2%)
- programming (0.2%)
- risklike (0.2%)
- shoot'em up (0.2%)
...
Build systems information available for 25.5% of all projects.

##### Build systems frequency (143)
...
##### C and C++ projects without build system information (229)
...
##### C and C++ projects with a build system different from CMake (87)
...
Platform information available for 52.0% of all projects.
