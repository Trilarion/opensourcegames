...
analyzed 1373 entries on 2019-11-18 17:38:15
...
70: Abuse, Ball and Paddle, Blender game engine, Bloboats, Crack Attack!, DarkPlaces, Duke3D, Dunnet, Excellent Bifurcation, Fanwor, FreeRails, FreeType, Freya Game Engine, GCompris, Gnome Chess, GNU Chess, GNU FreeDink, GNU Go, Granatier, GUSANOS, Hexoshi, Intricacy, KAtomic, KGoldrunner, KMines, KSnakeDuel, Libre: The Open Source Card Game, Libxml2, LordsAWar!, Mechanized Assault & eXploration Reloaded, Mines, Mocha Doom, Netrek, NetStatsBaseball, Nexuiz, NStars!, Open AL Soft, Open Rails, Open Simulator, Pacewar, Palapeli, Passage, phpRPG, pkg-config, PrBoom+, ProQuake 4, Quadrapassel, Ragel, ReTux, Rise of the Triad for Linux, Rocks'n'Diamonds, RogueBox Adventures, Simple DirectMedia Layer, Snowballz, T^3, Tactics Squad, Tales of Maj'Eyal, Tangomon, Tennix!, The Dark Mod, Transcend, Turious, Waste's Edge, WebChess, Wolfpack Empire, X-Moto, XBlast, XPilot NG, XZ Utils, Zatacka

## Code dependencies

With code dependency field 541 (39.4%)
...
Build systems information available for 31.9% of all projects.

##### Build systems frequency (438)
...
##### C and C++ projects without build system information (491)
...
##### C and C++ projects with a build system different from CMake (199)
...
Platform information available for 87.1% of all projects.
